...
namespace SimplePolicy.UnitTests
{
    ...
    public class UT_SimplePolicy
    {
        ...
        {
            var txLowPriority = MockGenerateTransaction(100000000 / 10000, 1022).Object; // 0.00001
            txLowPriority.IsLowPriority.Should().Be(true);
            txLowPriority.Size.Should().Be(1024); // 2 more in size (don't know why)
        ...
        {
            var txLowPriority = MockGenerateTransaction(100000000 / 10000, 1023).Object; // 0.00001
            txLowPriority.IsLowPriority.Should().Be(true);
            txLowPriority.Size.Should().Be(1025); // 2 more in size (don't know why)
            Settings.Default.MaxFreeTransactionSize.Should().Be(1024);
        ...
        {
            var txHighPriority = MockGenerateTransaction(100000000 / 1000, 1022).Object; // 0.0001
            txHighPriority.IsLowPriority.Should().Be(false);
            txHighPriority.Size.Should().Be(1024); // 2 more in size (don't know why)
            Settings.Default.MaxFreeTransactionSize.Should().Be(1024);
        ...
        {
            var txHighPriority = MockGenerateTransaction(100000000 / 1000, 1023).Object; // 0.0001
            txHighPriority.IsLowPriority.Should().Be(false);
            txHighPriority.Size.Should().Be(1025); // 2 more in size (don't know why)
            Settings.Default.MaxFreeTransactionSize.Should().Be(1024);
            Settings.Default.FeePerExtraByte.Should().Be(100000000 / 100000); // 0.000001 (1000 satoshi)
        ...
        {
            var txHighPriority = MockGenerateTransaction(100000000 / 1000, 1122).Object; // 0.0001
            txHighPriority.IsLowPriority.Should().Be(false);
            txHighPriority.Size.Should().Be(1124); // 2 more in size (don't know why)
            Settings.Default.MaxFreeTransactionSize.Should().Be(1024);
            Settings.Default.FeePerExtraByte.Should().Be(100000000 / 100000); // 0.000001 (1000 satoshi)
        ...
        {
            var txHighPriority = MockGenerateTransaction(100000000 / 1000, 1123).Object; // 0.0001
            txHighPriority.IsLowPriority.Should().Be(false);
            txHighPriority.Size.Should().Be(1125); // 2 more in size (don't know why)
            Settings.Default.MaxFreeTransactionSize.Should().Be(1024);
            Settings.Default.FeePerExtraByte.Should().Be(100000000 / 100000); // 0.000001 (1000 satoshi)
        ...
        {
            var txHighPriority = MockGenerateTransaction(100000000 / 1000 + 1000, 1123).Object; // 0.000101
            txHighPriority.IsLowPriority.Should().Be(false);
            txHighPriority.Size.Should().Be(1125); // 2 more in size (don't know why)
            Settings.Default.MaxFreeTransactionSize.Should().Be(1024);
            Settings.Default.FeePerExtraByte.Should().Be(100000000 / 100000); // 0.000001 (1000 satoshi)
